...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView lokasi_tv = findViewById(R.id.lokasi_tv);
        TextView daerah_tv = findViewById(R.id.nama_daerah);
...
//        lokasi2_tv.setMovementMethod(LinkMovementMethod.getInstance());
        ...
        String mLokasi = bundle.getString("sharelokasi");
        String mDaerah = bundle.getString("nama_daerah");
